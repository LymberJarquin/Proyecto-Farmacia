using CapasEntidad;
using CapasNegocio;
using Farmacia_Tutorial.Utilidades;
using System;
...
namespace Farmacia_Tutorial.Vistas
{
    public partial class ReporteCompras : Form
    {
        ...
        private void btnbuscarresultado_Click(object sender, EventArgs e)
        {
            ...
            List<CE_ReporteCompras> lista = new CN_Reporte().ObtenerReporteCompras(
            ...
            foreach (CE_ReporteCompras compra in lista)
            {
        ...
        {
            List<CE_Proveedor> lista = new CN_Proveedor().Listar();

            cboproveedor.Items.Add(new OpcionCombo() { Valor = 0, Texto = "TODOS" });
            foreach (CE_Proveedor item in lista)
            {
